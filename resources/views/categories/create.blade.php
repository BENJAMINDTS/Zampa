  ...
  <div class="max-w-xl mx-auto px-4 sm:px-6 py-8">
    ...
    <div class="flex items-center gap-3 mb-6">
      <a href="{{ route('categories.index') }}"
         ...
         class="p-2.5 min-h-[44px] min-w-[44px] flex items-center justify-center rounded-lg text-gray-500 dark:text-gray-400
      ...
      <div class="flex items-center gap-2">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100">Nueva categoría</h1>
      </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-md p-6">
      ...
      <form method="POST" action="{{ route('categories.store') }}" novalidate class="space-y-6">
        @csrf
        ...
        <div>
          ...
          <input type="text" name="name" id="name"
                 ...
                 placeholder="Ej: Entrantes, Postres, Cócteles…"
        ...
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
          <a href="{{ route('categories.index') }}"
             class="text-sm font-medium text-gray-600 dark:text-gray-400
                    ...
                    focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 rounded px-3 py-2 transition-colors">
            Cancelar
          </a>
          <button type="submit"
