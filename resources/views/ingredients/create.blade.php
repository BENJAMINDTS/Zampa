    ...
    <div class="max-w-md mx-auto px-4 sm:px-6 lg:px-8">
      <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
        <form method="POST" action="{{ route('ingredients.store') }}">
          @csrf
          <div class="mb-6">
            <label for="name" class="block text-gray-700 dark:text-gray-300 mb-2 font-bold">Nombre</label>
            <input type="text" name="name" id="name" required placeholder="Ej: Pan Brioche"
