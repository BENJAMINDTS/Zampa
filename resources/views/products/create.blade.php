    ...
    <div class="max-w-2xl mx-auto px-4 sm:px-6 py-4 sm:p-6 mt-4 sm:mt-10
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <div class="flex items-center gap-2">
                <span class="p-1.5 bg-green-100 dark:bg-green-900/40 rounded-md" aria-hidden="true">
                    <svg class="h-5 w-5 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          ...
                          class="block w-full rounded-md border-gray-300 dark:border-gray-600
                                 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100
                                 placeholder-gray-400 dark:placeholder-gray-500
                                 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('description') }}</textarea>
            </div>
            ...
            <div x-data="{ preview: null, fileName: null }">
                ...
                <div x-show="preview" x-cloak class="mt-2 flex items-center gap-3">
                    <img :src="preview" alt="Vista previa de la foto"
                         class="h-20 w-20 object-cover rounded-md border border-indigo-200 dark:border-indigo-700 shadow-sm ring-2 ring-indigo-400 ring-offset-1">
