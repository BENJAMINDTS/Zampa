            ...
            <div>
              ...
              <textarea id="description" name="description" rows="3"
                        ...
                        class="w-full border rounded-lg px-3 py-2.5 text-sm resize-none
                               dark:bg-gray-700 dark:text-gray-100
                               focus:ring-orange-400 focus:border-orange-400 focus:outline-none
                               {{ $errors->has('description') ? 'border-red-400 dark:border-red-600' : 'border-gray-300 dark:border-gray-600' }}">{{ old('description', $dailyMenu->description) }}</textarea>
              ...
              <label for="is_active"
                ...
                <div>
                  ...
                  <span class="block text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                    Solo los menús activos aparecen en la carta digital. Desactívalo para ocultarlo temporalmente sin eliminarlo.
                  </span>
                </div>
              </label>
            </div>
