...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <h1 class="text-xl sm:text-2xl font-bold text-white mt-2">Editar negocio</h1>
        <p class="text-slate-400 text-sm mt-1">Modifica los datos del negocio <strong class="text-slate-200">{{ $business->business_name }}</strong>.</p>
    </div>
            ...
            <div class="space-y-5">
                ...
                <div>
                    <label for="email" class="block text-sm font-medium text-slate-300 mb-1.5">
                        Email del responsable <span class="text-red-400" aria-hidden="true">*</span>
                    </label>
                    <input id="email"
                           name="email"
                           type="email"
                    ...
                    <select id="plan_id"
                        ...
                        @foreach($plans as $plan)
                            <option value="{{ $plan->id }}"
                                {{ old('plan_id', $business->plan_id) == $plan->id ? 'selected' : '' }}>
                ...
                <div class="pt-4 pb-4 border-b border-slate-800">
                    <h2 class="text-sm font-semibold text-slate-300 uppercase tracking-wider">Ubicación</h2>
                </div>

                {{-- Dirección --}}
                <div>
                    <label for="address" class="block text-sm font-medium text-slate-300 mb-1.5">
                        Dirección <span class="text-slate-500 font-normal">(opcional)</span>
                    </label>
                    <input id="address"
                           name="address"
                           type="text"
                ...
                <div>
                    <label class="block text-sm font-medium text-slate-300 mb-1.5">
                        Coordenadas <span class="text-slate-500 font-normal">(opcional — haz clic en el mapa)</span>
                    </label>
